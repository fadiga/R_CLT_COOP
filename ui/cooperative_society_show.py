...
#         formbox.addRow(FLabel(
#             u"<strong>3. Date de création de la société coopérative :</strong> {}".format(self.scoop.created_date)))
#         formbox.addRow(FLabel(
#             u"<strong>4. Activités exercées :</strong> {}".format(self.scoop.activity)))
#         formbox.addRow(FLabel(
#             u"<strong>5. Filière :</strong> {}".format(self.scoop.spinneret)))
#         formbox.addRow(FLabel(
#             u"<strong>6. Forme de la société coopérative :</strong> {}".format(self.scoop.forme)))
#         # Capital Social Initial
#         capital_formbox = QFormLayout()
#         capital_formbox.addRow(
#             FLabel("<strong> Montant de la part sociale : </strong> {}".format(self.scoop.apports_numeraire + self.scoop.apports_nature + self.scoop.apports_industrie)))
#         capital_formbox.addRow(FLabel(
#             "<strong> 7.1 Montant apports en numéraire : </strong> {}".format(self.scoop.apports_numeraire)))
#         capital_formbox.addRow(FLabel(
#             "<strong> 7.2 Montant apports en nature : </strong> {}".format(self.scoop.apports_nature)))
#         capital_formbox.addRow(FLabel(
#             "<strong> 7.3 Montant apports en industrie : </strong> {}".format(self.scoop.apports_industrie)))
#         self.capitalSGroupBox = QGroupBox("7. Montant Capital Social Initial")
