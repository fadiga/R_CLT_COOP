...
from Common.ui.common import (
    FWidget, FPageTitle, FRLabel, FHeader, ErrorLabel, Button_save, FLabel, IntLineEdit)
...
class CheckListViewWidget(FWidget):
    ...
    def __init__(self, parent=0, dmd=None, *args, **kwargs):
        ...
        row += 1
        self.lien_commun_status_field = IntLineEdit()
        self.lien_commun_ri_field = IntLineEdit()
        ...
        row += 1
        self.coord_initiateur_status_field = IntLineEdit()
        self.coord_initiateur_ri_field = IntLineEdit()
        ...
        row += 1
        self.max_min_admin_cg_status_field = IntLineEdit()
        self.max_min_admin_cg_ri_field = IntLineEdit()
        ...
        row += 1
        self.max_min_admin_ca_status_field = IntLineEdit()
        self.max_min_admin_ca_ri_field = IntLineEdit()
        ...
        row += 1
        self.dispositions_cg_status_field = IntLineEdit()
        self.dispositions_cg_ri_field = IntLineEdit()
        ...
        row += 1
        self.dispositions_ca_status_field = IntLineEdit()
        self.dispositions_ca_ri_field = IntLineEdit()
        ...
        row += 1
        self.max_min_cs_s_status_field = IntLineEdit()
        self.max_min_cs_s_ri_field = IntLineEdit()
        ...
        row += 1
        self.max_min_cs_ca_status_field = IntLineEdit()
        self.max_min_cs_ca_ri_field = IntLineEdit()
        ...
        row += 1
        self.dispositions_mo_status_field = IntLineEdit()
        self.dispositions_mo_ri_field = IntLineEdit()
        ...
        row += 1
        self.mandat_cs_status_field = IntLineEdit()
        self.mandat_cs_ri_field = IntLineEdit()
        ...
        row += 1
        self.parts_sociales_status_field = IntLineEdit()
        self.parts_sociales_ri_field = IntLineEdit()
        ...
        row += 1
        self.declatation_status_field = IntLineEdit()
        self.declatation_ri_field = IntLineEdit()
        ...
        row += 1
        self.id_apport_numeraire_status_field = IntLineEdit()
        self.id_apport_numeraire_ri_field = IntLineEdit()
        ...
        row += 1
        self.id_apport_nature_status_field = IntLineEdit()
        self.id_apport_nature_ri_field = IntLineEdit()
        ...
        row += 1
        self.evaluation_apport_status_field = IntLineEdit()
        self.evaluation_apport_ri_field = IntLineEdit()
        ...
        row += 1
        self.capital_social_status_field = IntLineEdit()
        ...
        row += 1
        self.valeur_nominale_status_field = IntLineEdit()
        self.valeur_nominale_ri_field = IntLineEdit()
        ...
        row += 1
        self.stipulations_status_field = IntLineEdit()
        self.stipulations_ri_field = IntLineEdit()
        ...
        row += 1
        self.modalite_status_field = IntLineEdit()
        self.modalite_ri_field = IntLineEdit()
        ...
        row += 1
        self.signature_int_status_field = IntLineEdit()
        self.signature_int_ri_field = IntLineEdit()
        ...
        row += 1
        self.etendue_status_field = IntLineEdit()
        self.etendue_ri_field = IntLineEdit()
        ...
        row += 1
        self.rendement_status_field = IntLineEdit()
        self.rendement_ri_field = IntLineEdit()
        ...
        row += 1
        self.remuneration_status_field = IntLineEdit()
        self.remuneration_ri_field = IntLineEdit()
        ...
        row += 1
        self.limite_imposee_status_field = IntLineEdit()
        self.limite_imposee_ri_field = IntLineEdit()
        ...
        row += 1
        self.indemnit_status_field = IntLineEdit()
        self.indemnit_ri_field = IntLineEdit()
        ...
        row += 1
        self.souscription_status_field = IntLineEdit()
        self.souscription_ri_field = IntLineEdit()
        ...
        row += 1
        self.suspension_status_field = IntLineEdit()
        self.suspension_ri_field = IntLineEdit()
        ...
        row += 1
        self.attribution_status_field = IntLineEdit()
        self.attribution_ri_field = IntLineEdit()
        ...
        row += 1
        self.prescriptions_status_field = IntLineEdit()
        self.prescriptions_ri_field = IntLineEdit()
    ...
    def save(self):
        ...
        self.check_l.max_min_admin_cg_status_field = self.to_int_or_none(
    ...
    def add_element(self, objet_, row, text, field1, field2, helper=None):
        ...
        if helper:
            objet_.addWidget(
                FHeader(helper, css="font-size: 15px;"), row, 3)
