...
from models import (CooperativeMember, Office, CheckList,
                    CooperativeCompanie, Demande, Immatriculation)
...
class Setup(AdminDatabase):
    ...
    def __init__(self):
        ...
        for md in [Office, CooperativeMember, CooperativeCompanie, Demande,
